...
`scripts/hooks/`, `.github/hooks/`, `docs/workstate/contracts/`,
`docs/workstate/rules/`, `Makefile.d/`, and `scripts/workstate/`), registers
...
| --- | --- | --- |
| Claude Code plugin (`/branch-review`, …) | `.workstate/generated/plugins/workstate-system/base/claude` | `make plugins-build` |
| Codex plugin | `.workstate/generated/plugins/workstate-system/base/codex` | `make plugins-build` |
