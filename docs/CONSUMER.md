...
| Server                   | Command line                                                |
| ------------------------ | ----------------------------------------------------------- |
| `workstate-handoff-mcp`      | `uvx mcp-workstate-handoff@0.13.1 --workspace-root . serve-stdio`      |
...
.workstate/generated/plugins/workstate-system/effective/cursor/skills/<slug>/SKILL.md
.workstate/generated/plugins/workstate-system/effective/grok/skills/<slug>/SKILL.md
```
