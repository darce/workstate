...
| Server                   | Command line                                                |
| ------------------------ | ----------------------------------------------------------- |
| `workstate-handoff-mcp`      | `uvx mcp-workstate-handoff@0.12.8 --workspace-root . serve-stdio`      |
| `workstate-orchestrator-mcp` | `uvx mcp-workstate-orchestrator[bridge]@0.6.5 --workspace-root . serve-stdio` |
