...
| Server                   | Command line                                                |
| ------------------------ | ----------------------------------------------------------- |
| `workstate-handoff-mcp`      | `uvx mcp-workstate-handoff@0.12.9 --workspace-root . serve-stdio`      |
| `workstate-orchestrator-mcp` | `uvx mcp-workstate-orchestrator[bridge]@0.6.6 --workspace-root . serve-stdio` |
