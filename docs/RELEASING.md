...
scripts/release.sh package workstate-protocol
```
...
scripts/release.sh package mcp-workstate-handoff
```
...
scripts/release.sh package mcp-workstate-orchestrator
```
...
scripts/release.sh package workstate-bootstrap
```
...
scripts/release.sh package workstate-codex-bridge
```
...
```bash
scripts/release.sh package workstate-system
scripts/release.sh package workstate-bootstrap
```
