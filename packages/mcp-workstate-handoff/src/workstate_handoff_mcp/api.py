    ...
    if provider is None:
        return {
            ...
            "note": (
                ...
                "(WORKSTATE_HANDOFF_EMBEDDING_MODEL/_TOKENIZER + matching _SHA256 pins); "
    ...
    try:
        ...
        return {
            ...
            "remediation": (
                ...
                "configured WORKSTATE_HANDOFF_EMBEDDING_*_SHA256. Reinstall the model artifact "
    ...
    try:
        ...
        return {
            ...
            "warning": (
                ...
                "'mcp-workstate-handoff[embeddings]' or semantic reinjection will "
