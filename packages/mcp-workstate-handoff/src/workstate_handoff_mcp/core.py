...
def load_session(
    ...
    WORKSTATE-REF-71 implementation note: ``read_profile`` selects a named intent shape
    ...
    # WORKSTATE-REF-71 implementation note: compound budget planning. We resolve the state
    ...
    # caller's ``detail`` (preserves pre-WORKSTATE-REF-71 behavior where the same
    ...
    # WORKSTATE-REF-71 implementation note: compound read_budget attached whenever the caller
...
def close_slice(
    ...
    # WORKSTATE-REF-82 implementation note: make the public close_slice contract true by regenerating
