...
_ERROR_VARIANT = WriteContract(
    ...
    optional=[
        ...
        # persisted — agent_errors has no actor columns (WS-ERRTEL-01
...
REGISTRY: dict[str, WriteContract] = {
    ...
    # self-captured (WS-ERRTEL-01 review finding REV-C-002).
...
# implementation note self-capture scope (WS-ERRTEL-01 review finding REV-A-001):
