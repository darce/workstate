...
def test_run_doctor_strict_mode_canonical_workstate_name(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    """implementation note B4: canonical WORKSTATE_HANDOFF_DOCTOR_STRICT enables strict mode
    (legacy AGENT_HANDOFF_DOCTOR_STRICT still honored via the alias fallback)."""
    from unittest.mock import MagicMock, patch
