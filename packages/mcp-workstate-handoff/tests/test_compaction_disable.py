...
def test_disabled_via_env_short_circuits_advisory(
    ...
    """AGENT_HANDOFF_COMPACTION_DISABLED truthy → disabled=True, source='env'."""
...
def test_env_disabled_survives_invalid_floor_env(
    ...
    env = {
        "CLAUDE_SESSION_TRANSCRIPT_PATH": str(transcript),
        "AGENT_HANDOFF_COMPACTION_DISABLED": "1",
        "AGENT_HANDOFF_COMPACTION_MIN_NEW_TURNS": "not-an-int",
    }
    ...
    monkeypatch.setenv("AGENT_HANDOFF_COMPACTION_DISABLED", "1")
    monkeypatch.setenv("AGENT_HANDOFF_COMPACTION_MIN_NEW_TURNS", "not-an-int")
