...
def test_schema_version_advanced_to_v11(isolated_handoff: dict) -> None:
    """Cold-start bootstrap lands on the WORKSTATE-REF-68 schema sentinel."""
...
def test_lifecycle_flag_default_is_true(tmp_path: Path) -> None:
    ...
    ``AGENT_HANDOFF_FINDING_LIFECYCLE_STATES=0`` env override) must still work
    as escape hatches."""
