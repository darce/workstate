...
| --- | --- | --- | --- | --- |
| MCP handoff surface | `agentic-tooling` | `docs/agentic/contracts/workstate-handoff-mcp.md` | Installed `workstate-handoff-mcp` API and CLI surface | Orchestrator, workers, review flows |
...
| --- | --- |
| MCP review modes and status values | `docs/agentic/contracts/workstate-handoff-mcp.md` and installed `workstate-handoff-mcp` |
