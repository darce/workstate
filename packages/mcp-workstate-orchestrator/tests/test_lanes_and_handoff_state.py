...
def test_get_latest_slice_review_packet_returns_branch_packet(isolated_handoff: dict) -> None:
    ...
    _parse(
        mcp_server.worker_reports(
            ...
            changed_files=[
                ...
                "docs/agentic/contracts/workstate-handoff-mcp.md",
            ],
    ...
    assert payload["packet"]["contract_files"] == ["docs/agentic/contracts/workstate-handoff-mcp.md"]
    ...
    _parse(
        mcp_server.record_decision(
            ...
            rationale=(
                ...
                "\n## Schema / Contract Changes\n"
                "- docs/agentic/contracts/workstate-handoff-mcp.md: latest slice packet query documented.\n"
                "\n## Open Threads\n"
                "- none.\n"
            ),
            actor={"lane_id": "domain"},
...
def test_get_lane_activity_archival_format_returns_compact_summary(isolated_handoff: dict) -> None:
    ...
    _parse(
        mcp_server.record_review_finding(
            ...
            finding_id="ARCH-1",
            severity="high",
            file_path="docs/agentic/contracts/workstate-handoff-mcp.md",
...
def test_get_latest_slice_review_packet_partitions_external_changed_files(isolated_handoff: dict) -> None:
    ...
    _parse(
        mcp_server.record_decision(
            ...
            changed_files=[
                ...
                "docs/agentic/contracts/workstate-orchestrator-mcp.md",
            ],
        )
    )
    ...
    assert packet["changed_files"] == ["docs/agentic/contracts/workstate-orchestrator-mcp.md"]
    ...
    assert packet["contract_files"] == ["docs/agentic/contracts/workstate-orchestrator-mcp.md"]
