...
class InstallRequest:
    ...
    install_claude_error_hook: bool
    install_claude_error_hook_local: bool
...
def build_install_plan(
    ...
    *,
    ...
    if request.install_claude_stop_hook:
    ...
    if request.install_claude_reinject_hook:
    ...
    if request.install_claude_error_hook:
        active_flags.add("--install-claude-error-hook")
    if request.install_claude_error_hook_local:
        active_flags.add("--install-claude-error-hook-local")
