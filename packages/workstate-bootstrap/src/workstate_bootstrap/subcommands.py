...
_HOOK_OPT_IN_KWARGS: dict[str, str] = {
    ...
    "--install-claude-error-hook": "install_claude_error_hook",
    "--install-claude-error-hook-local": "install_claude_error_hook_local",
}
...
def _repair_failed_presync_install(
    ...
    (implementation note implementation note, S6-02).
...
def repair(
    *,
    ...
    is_worktree_source = (
        str(manifest.get("source_kind") or "git_overlay") == "worktree"
    )
