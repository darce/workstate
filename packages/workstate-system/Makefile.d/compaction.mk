...
# when the consumer manages its own venv. The legacy `AGENT_HANDOFF_*` Make
# variables are still accepted for one cutover release.

WORKSTATE_HANDOFF_COMPACTION_CLI ?= $(or $(AGENT_HANDOFF_COMPACTION_CLI),uvx --from mcp-workstate-handoff python -m workstate_handoff_mcp.compaction_cli)
...
WORKSTATE_HANDOFF_COMPACTION_OP_CLI ?= $(or $(AGENT_HANDOFF_COMPACTION_OP_CLI),uvx --from mcp-workstate-handoff mcp-workstate-handoff compaction)
