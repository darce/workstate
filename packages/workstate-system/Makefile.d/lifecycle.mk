...
.PHONY: task-start task-finish context slice-start slice-commit review-ready close-check \
...
# Canonical workflow step order lives in docs/agentic/rules/development-workflow.md;
...
tasks-gc:              ; @mcp-workstate-handoff tasks-gc $(if $(APPLY),--apply)
