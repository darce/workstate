...
# consumer manages its own venv. The legacy `AGENT_HANDOFF_PLAN_CLI` name is
# still accepted for one cutover release.
#
...
# Forwards to the workstate-system lifecycle runner (NOT the agent-handoff
