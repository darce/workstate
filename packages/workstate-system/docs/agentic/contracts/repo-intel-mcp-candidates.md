...
| `get_api_contract` | docs | drop | It is a thin wrapper around reading a contract file under `docs/agentic/contracts/`. No curated resolution logic justifies a server. |
