...
- `docs/agentic/contracts/harness-protocol.yaml` owns the portable data contract: advisory field name, thresholds, transcript discovery rules, and unknown-harness behavior.
...
`docs/agentic/environment-variables.md` for the cross-package
registry.
