...
| agentic observability | `docs/agentic/consumer-setup.md`, `scripts/test_handoff_review_run.py`, `packages/workstate-codex-bridge/tests/test_bridge.py` | Add an agentic workflow suite that confirms handoff/dashboard writes and structured-turn telemetry still work in the consumer repo. |
