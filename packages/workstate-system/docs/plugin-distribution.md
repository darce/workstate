...
- Consumer-repo operators installing the plugin
  into Claude Code, Codex, or Grok.
...
`.workstate/generated/plugins/workstate-system/base/{claude,codex,grok}`. That is
...
```json
{
  "mcpServers": {
    "workstate-handoff-mcp": {
      "type": "stdio",
      "command": "uvx",
      "args": ["mcp-workstate-handoff@0.12.9", "--workspace-root", ".", "serve-stdio"]
    },
    "workstate-orchestrator-mcp": {
      "type": "stdio",
      "command": "uvx",
      "args": ["mcp-workstate-orchestrator[bridge]@0.6.6", "--workspace-root", ".", "serve-stdio"]
    }
  }
}
```
...
```bash
make plugins-build   # emit .workstate/generated/plugins/workstate-system/base/{claude,codex,grok}/
