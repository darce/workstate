...
```json
{
  "mcpServers": {
    "workstate-handoff-mcp": {
      "type": "stdio",
      "command": "uvx",
      "args": ["mcp-workstate-handoff@0.12.3", "--workspace-root", ".", "serve-stdio"]
    },
    "workstate-orchestrator-mcp": {
      "type": "stdio",
      "command": "uvx",
      "args": ["mcp-workstate-orchestrator@0.6.0", "--workspace-root", ".", "serve-stdio"]
    }
  }
}
```
...
> trees only: `base/{claude,codex}` for source-tree build checks and
