"""WORKSTATE-REF-03 implementation note: the `branch_isolation` contract splits into two
...
from _branch_isolation_guard import find_dirty_state_files  # noqa: WORKSTATE-REF-402
...
# ---------------------------------------------------------------------------
# Dirty state-file detection (the WORKSTATE-REF-51 over-fire fix).
# ---------------------------------------------------------------------------
