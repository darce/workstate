...
def test_consumer_overlay_symlink_is_preferred_over_monorepo_path(
    ...
    agent-handoff source under
    ``.agentic/remote/packages/mcp-workstate-handoff/src`` without
    ...
    """
    mod = _load_hook_module()
    overlay_src = tmp_path / ".agentic" / "remote" / "packages" / "mcp-workstate-handoff" / "src"
