"""Per-package pytest path-guard helper (WORKSTATE-REF-41 implementation note).
...
Opt-out via ``AGENTIC_DISABLE_PYTEST_PATH_GUARD=1`` for cross-worktree
...
OPT_OUT_ENV = "AGENTIC_DISABLE_PYTEST_PATH_GUARD"
...
def check_path_guard(worktree_root: Path) -> None:
    ...
    Honors the ``AGENTIC_DISABLE_PYTEST_PATH_GUARD=1`` opt-out.
    """
