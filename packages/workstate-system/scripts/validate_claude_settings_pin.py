...
Exit code is 0 when the file matches the WORKSTATE-REF-02 pin contract, 1 when
...
EFFECTIVE_PLUGIN_PREFIX = "./.agentic/generated/plugins/workstate-system/effective/"
