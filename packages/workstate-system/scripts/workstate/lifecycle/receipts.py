...
class DoctorMcp:
    ...
    # way). ``mcp_status`` covers the agent-handoff endpoint;
    # ``orchestrator_status`` covers the agent-orchestrator endpoint.
...
class StatusReceipt:
    ...
    # docs/agentic/rules/development-workflow.md "Canonical Workflow
