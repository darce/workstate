...
_LIFECYCLE_PKG_DIR = PACKAGE_ROOT / "workstate_system" / "payload" / "scripts" / "workstate" / "lifecycle"
...
def test_hooks_facet_detects_installed_nested_claude_adapter(git_repo: Path) -> None:
    ...
    _write_managed_stop_adapter(
        git_repo, _CLAUDE_SHARED_ADAPTER_TARGET, shape="claude"
    )
