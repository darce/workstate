...
def test_review_ready_passes_workspace_root_to_handoff_cli(
    ...
    ``AGENT_HANDOFF_WORKSPACE_ROOT must be set``. Without this flag the
    ...
    body = (
        ...
        "  fi\n"
        "done\n"
        'echo "AGENT_HANDOFF_WORKSPACE_ROOT must be set or passed via --workspace-root" 1>&2\n'
        "exit 2\n"
    )
