...
PAYLOAD_ROOT = REPO_ROOT / "packages" / "workstate-system" / "workstate_system" / "payload"
GENERATOR = PAYLOAD_ROOT / "scripts" / "generate_agent_workflows.py"

FRAGMENTS = Path(__file__).resolve().parents[2] / "workstate_system" / "payload" / "Makefile.d"
