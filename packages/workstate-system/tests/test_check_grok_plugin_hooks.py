...
from scripts.check_harness_sync import (  # noqa: WORKSTATE-REF-402
    ...
    _check_capture_agent_errors_grok_command,
...
def test_capture_agent_errors_post_tool_use_declares_grok_command() -> None:
    import yaml
    ...
    assert _check_capture_agent_errors_grok_command(contract) == []
