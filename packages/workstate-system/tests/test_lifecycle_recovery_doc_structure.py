"""WORKSTATE-REF-04 implementation note: structure lint for ``docs/agentic/rules/lifecycle-recovery.md``.
...
DOC_PATH = PACKAGE_ROOT / "docs" / "agentic" / "rules" / "lifecycle-recovery.md"
