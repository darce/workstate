...
SKILL_PATH = PACKAGE_ROOT / "skills" / "review-parallel" / "body.md"
SKILL_YAML_PATH = PACKAGE_ROOT / "skills" / "review-parallel" / "skill.yaml"
PROMPT_DIR = PACKAGE_ROOT / "config" / "agent-workflows" / "prompts" / "review-parallel"
BASELINE_PATH = (
    MONOREPO_ROOT
    / "packages"
