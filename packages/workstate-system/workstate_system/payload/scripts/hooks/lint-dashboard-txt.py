...
WORKSTATE-REF-17-7 implementation note renamed the operator snapshot from `DASHBOARD.md` to
...
regressions on every branch. WORKSTATE-REF-17-9 implementation note.
"""
