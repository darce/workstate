...
WORKSTATE-REF-20 / Layer 3 of the heredoc-eradication bug class fix. Three reasons
...
1. **Apostrophes inside Python comments close the bash single-quoted
   string prematurely.** WORKSTATE-REF-17 hit this on a comment that read
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        "  for the canonical pattern. WORKSTATE-REF-20 / heredoc bug class eradication.",
        file=sys.stderr,
    )
    return 1
