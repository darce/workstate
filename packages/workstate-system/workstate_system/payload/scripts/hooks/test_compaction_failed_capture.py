"""implementation note (WS-CMPERR-01): Stop-hook compaction_failed self-capture."""
...
def test_capture_agent_errors_resolve_harness_grok_workspace_root_sniff(monkeypatch) -> None:
    """REV-E-010: grok compat-delivery has no inline env export (WORKSTATE-REF-04);
...
def test_invalid_settings_records_compaction_failed_row(workspace: Path) -> None:
    ...
    env = {
        "WORKSTATE_HANDOFF_COMPACTION_MIN_NEW_TURNS": "abc",
