...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Legacy internal_* aliases must remain documented as one-release
        # back-compat so operators discover both names from one page.
        "internal_COMPACTION_DISABLED",
        "internal_COMPACTION_MIN_NEW_TURNS",
        "internal_COMPACTION_MIN_NEW_TOKENS",
        "deprecated",
        "make compact-now",
