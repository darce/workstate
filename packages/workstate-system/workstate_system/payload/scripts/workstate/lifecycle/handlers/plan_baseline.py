...
def evaluate_plan_baseline(
    ...
    *,
    ...
    # WORKSTATE-REF-08: when an explicit review task ref is supplied, planning verdict
    # and open-finding evidence is read from that WORKSTATE-REF-row review while the
    ...
    if verdict is None:
        ...
        # WORKSTATE-REF-08 implementation note: only a passing review under another (WORKSTATE-REF) ref is
