...
cmd_package() {
    ...
    # Fail closed on personal info / internal project ids in the built artifacts.
    if ! python scripts/check_shipped_privacy.py --package "$pkg" --dist-dir "packages/$pkg/dist"; then
